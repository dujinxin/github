//
//  EGOBottomAutomaticLoadingFooterView.m
//  JXView
//
...
@interface EGOBottomAutomaticLoadingFooterView (Private)
- (void)setState:(EGOPullRefreshState)aState;
@end

@implementation EGOBottomAutomaticLoadingFooterView
...
- (void)egoRefreshScrollViewDidScroll:(UIScrollView *)scrollView {
	...
	if (_state == EGOOPullRefreshLoading) {
		...
		if (_state == EGOOPullRefreshPulling &&
            (scrollView.contentOffset.y+scrollView.frame.size.height) < scrollView.contentSize.height+BOTTOM_LOADING &&
            scrollView.contentOffset.y > 0.0f && !_loading) {
            
			[self setState:EGOOPullRefreshNormal];
		} else if (_state == EGOOPullRefreshNormal &&
                   scrollView.contentOffset.y+(scrollView.frame.size.height) > scrollView.contentSize.height+BOTTOM_LOADING && !_loading) {
...
- (void)egoRefreshScrollViewDidEndDragging:(UIScrollView *)scrollView {
	...
	if (scrollView.contentOffset.y+(scrollView.frame.size.height) > scrollView.contentSize.height+BOTTOM_LOADING  && !_loading) {
