...
#import "DJXRootAViewController.h"

@interface DJXRootAViewController ()

@end

@implementation DJXRootAViewController
...
-(void)setFooterView{
    ...
    }else
	{
        ...
        _refreshFooterView = [[EGOBottomAutomaticLoadingFooterView alloc] initWithFrame:
